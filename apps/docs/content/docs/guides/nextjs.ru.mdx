...
<Cards>
  <Card title="Vite + React" description="Запускаемый канон" href="/guides/vite-react" />
  <Card title="Склейка модулей" description="Провайдеры и события" href="/guides/cross-module-wiring" />
