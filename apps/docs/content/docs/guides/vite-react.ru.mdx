---
title: "Vite + React"
description: "Канонический запускаемый-пример DMA на Vite + React."
icon: "Zap"
---
...
<Cards>
  <Card title="Склейка модулей" description="паттерн onAddedToCart" href="/guides/cross-module-wiring" />
