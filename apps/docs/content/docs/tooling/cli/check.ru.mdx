...
| `feature-has-inbound` | У feature есть входящих рёбер от другого модуля | Перенесите модуль в `services/<name>/`, пересмотрите `public/` | [Эволюция кода](/concepts/evolution) |
