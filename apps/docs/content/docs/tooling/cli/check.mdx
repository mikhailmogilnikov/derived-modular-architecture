...
| `feature-has-inbound` | Feature has inbound from another module | `dma promote <name> --apply`, then revisit `public/` | [dma promote](/tooling/cli/promote) · [Code evolution](/concepts/evolution) |
